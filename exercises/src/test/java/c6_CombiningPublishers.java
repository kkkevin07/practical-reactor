...
public class c6_CombiningPublishers extends CombiningPublishersBase {
    ...
    public void task_executor() {
        ...
        tasks = taskExecutor().flatMap(Mono::then);
    ...
    public void streaming_service() {
        ...
        messageFlux = streamingService().flatMapMany(messageFlux1 -> messageFlux1);
    ...
    public void task_executor_again() {
        //todo: feel free to change code as you need
        Flux<Void> tasks = null;
        tasks = taskExecutor().concatMap(voidMono -> voidMono);
    ...
    public void plan_b() {
        //todo: feel free to change code as you need
        Flux<String> stonks = null;
        Flux.concatDelayError(getStocksLocalCache(), getStocksRest());
